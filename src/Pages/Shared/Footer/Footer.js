            ...
            <div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
                <div className="grid grid-cols-12">
                    ...
                    <div className="col-span-3 text-center md:text-left md:col-span-3">
                        ...
                        <ul>
                            <li>
                                <a rel="noopener noreferrer" href="#" className="hover:text-teal-600">Branding</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#" className="hover:text-teal-600">Design</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#" className="hover:text-teal-600">Marketing</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#" className="hover:text-teal-600">Advertisement</a>
                            </li>
                        </ul>
                    </div>
                    <div className="col-span-3 text-center md:text-left md:col-span-3">
                        ...
                        <ul>
                            <li>
                                <a rel="noopener noreferrer" href="#" className="hover:text-teal-600">About Us</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#" className="hover:text-teal-600">Jobs</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#" className="hover:text-teal-600">Contact</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#" className="hover:text-teal-600">Privacy Poliy</a>
                            </li>
                    ...
                    <div className="col-span-3 text-center md:text-left md:col-span-3">
                        ...
                        <ul>
                            <li>
                                <a rel="noopener noreferrer" href="#" className="hover:text-teal-600">Terms of Use</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#" className="hover:text-teal-600">Cookie Policy</a>
                            </li>
